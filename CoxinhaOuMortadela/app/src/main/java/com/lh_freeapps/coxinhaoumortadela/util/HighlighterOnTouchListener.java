...
public class HighlighterOnTouchListener implements View.OnTouchListener {
    ...
    private static final HighlighterOnTouchListener touchListener = new HighlighterOnTouchListener();


    public static HighlighterOnTouchListener getInstance() {
        return touchListener;
    }


    private HighlighterOnTouchListener() {}
